...
const checkIfValid = () => {
    ...
    if(greens.length > 0) {
        for (let greenIndex = 0; greenIndex < greens.length; greenIndex++) {
            ...
            if(green.letter == marcGuess[green.position]) {
                ...
                if(marcGuess == word) console.log("filtered at green")
                greenValid = false;
                break;
            }
        }
    ...
    if(yellows.length > 0) {
        for (let yellowIndex = 0; yellowIndex < yellows.length; yellowIndex++) {
            ...
            if(marcGuess.includes(yellow.letter) && yellow.letter != marcGuess[yellow.position]) {
                ...
                for (let greenIndex = 0; greenIndex < greens.length; greenIndex++) {
                    ...
                    if(yellow.letter == green.letter) {
                        ...
                        if(marcGuess == word) console.log("filtered at yellow")
                        yellowValid = false;
                    }
                }
            } else {
            ...
            if(!yellowValid) {
                if(marcGuess == word)console.log("doesn't contain yellow letter", yellow.letter);
                break;
            }
        }
    } else {
            ...
            if(!marcGuess.includes(grey.letter)) { // if Marcs guess doesn't include grey letter 
                    ...
                    if(grey.letter == green.letter) {
                        ...
                        for (let yellowIndex = 0; yellowIndex < yellows.length; yellowIndex++) { // if it's not equal to a green letter but it's equal to a yellow letter
                            ...
                            if(grey.letter == yellow.letter) {
                                ...
                                if(marcGuess == word) console.log("filtered at grey, not green or yellow", grey.letter)
                                greyValid = false;
                            }
                        }
                    }
                ...
                for (let yellowIndex = 0; yellowIndex < yellows.length; yellowIndex++) { // if it does but it's equal to a yellow letter
                    ...
                    if(grey.letter == yellow.letter) {
                        ...
                        if(marcGuess == word) console.log("filtered at grey, not yellow")
                        greyValid = false;
                    }
                }
            } else { // if it's in Marcs guess and there's no greens or yellows 
                if(marcGuess == word) console.log("filtered at grey")
                greyValid = false;
                break;
            }

            if(!greyValid) {
                if(marcGuess == word)console.log("contains grey letter", grey.letter)
                break;
            }
        }
    } else {
    ...
    if(marcGuess == word) console.log(greens, yellows, greys, greenValid, yellowValid, greyValid)
    if(possibleGuesses.length == 0) console.log("out of guesses", word)
